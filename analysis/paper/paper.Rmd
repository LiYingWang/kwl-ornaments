...
To investigate whether the types of ornaments changes resulted from culture contact and how they changed, we compare ornaments from pre-European, European contact period, and Chinese contact period. The results a general pattern that most ornaments appeared in the pre-European contact period, reached a peak in quantity during the European contact and dropped down during the Chinese contact. This trend can be seen on the ornaments including golden bead, agate bead, metal ring, and bell. However, glass bead shows different pattern that higher frequency in the pre-European contact, and then the quantity goes down over time in the European and Chinese contact periods.       
...
Table \@ref(tab:taball) shows the subtypes for the major ornaments. 
