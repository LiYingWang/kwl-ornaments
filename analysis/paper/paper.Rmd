...
To assess whether the distribution of ornaments present different density that can indicate the changes caused by global trade network brought by the Europeans, point pattern analysis is used to measure and test the density of ornaments across three time periods. We assume a uniform point density across the research area before European contact period, that is, randomly distributed, and test the null hypothesis that is there is no cluster of ornaments across the sapce during the European contact periods. 
