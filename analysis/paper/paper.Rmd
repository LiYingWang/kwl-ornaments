...
This research compares the chronological and spatial distribution of trade ornaments during different time periods with foreign contacts, including European and Chinese Contacts. The principle of classification for ornaments is based on the material and shape that was used in the excavation report. For quantitative comparison between different time periods, minor types of ornaments with similar shapes from the same material are combined as one category that will be explained in each material section. The results are presented by the general distribution across the 40 sample squares, followed by each major types of materials from three analytical units that are before European contact, during European contact, and Chinese contact.  

chronological distribution

Sketch of results section, should have some graphs and tables for these: 
...
```{r read-in-the-data}
>>>>>>> 2e93107551460aba7536abe8fe4ba4ed85208ea3
library(here)
