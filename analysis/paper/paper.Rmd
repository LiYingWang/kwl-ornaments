...
<--Add a paragraph about exchange network before European contact-->
...
ggplot(ornaments_period_join) +
  geom_sf(data = sample_units, fill = NA) +
  geom_sf(data = ornaments_period_join, aes(fill =n), alpha = 0.9) +
  facet_wrap(~ period) +
  labs(fill = "frequency") +
...
ggplot(ornaments_period_join_metal) +
  geom_sf(data = sample_units, fill = NA) +
  geom_sf(data = ornaments_period_join_metal, aes(fill = n), alpha = 0.9) +
  facet_wrap(~ period) +
...
ggplot(ornaments_period_join_bell) +
  geom_sf(data = sample_units, fill = NA) +
  geom_sf(data = ornaments_period_join_bell, aes(fill = n), alpha = 0.9) +
  facet_wrap(~ period) +
...
Indirect influence of colonialism has been proposed recently and some students in many parts of the world [@Trabert2017]. Kiwulan in Northeastern Taiwan is an especially important case study where the location was relatively isolated and peripheral that can provide valuable insight into the discussion of influence of indirect colonial contacts.
