...
Figure \@ref(fig:plot-all-spatial-pattern) presents the spatial distribution of the ornaments for each time period. It shows that ornaments concentrate on one specific square in the pre-European contact, and more ubiquitous during the European contact and 
