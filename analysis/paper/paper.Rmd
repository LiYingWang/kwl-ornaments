...
ggplot(glass_bead_shape) +
  ...
  coord_flip() +
  labs(y = "Frequency",
       x = "Shape of Glass Bead") +
  theme_minimal(base_size = 14)
```

```{r plot-altogether, fig.cap= "Frequency of "}
library(cowplot)
plot_grid(agate_bead_shape_plot, ring_shape_plot,
          bell_shape_plot, glass_bead_plot,
